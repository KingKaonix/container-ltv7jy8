...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ltv7jy8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ltv7jy8.containers.anotherwebservice.com/
...
```
git clone git@github.com:KingKaonix/container-ltv7jy8.git
cd container-ltv7jy8
```
...
```
docker attach container-ltv7jy8
```
